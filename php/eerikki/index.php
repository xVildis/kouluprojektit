...
// ----------------------------------------------------
// Harjoitus 9 - kirjautuminen sivustolle
// ----------------------------------------------------
session_start();
$ok = false;
// tähän väliin tarvitaan lomakkeenkäsitteljä
...
// ----------------------------------------------------
// -------- jos ollaan kirjauduttu
require "./partials/navi.php";

// navin jälkeen uloskirjautuminen:
...
// --------- nin näytetään tuo tuolla yläpuolella
}
